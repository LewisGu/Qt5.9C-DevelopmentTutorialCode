...
void QwBattery::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QwBattery *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QwBattery::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QwBattery::powerLevelChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QwBattery::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QwBattery.data,
    qt_meta_data_QwBattery,
    qt_static_metacall,
    nullptr,
    nullptr
} };
