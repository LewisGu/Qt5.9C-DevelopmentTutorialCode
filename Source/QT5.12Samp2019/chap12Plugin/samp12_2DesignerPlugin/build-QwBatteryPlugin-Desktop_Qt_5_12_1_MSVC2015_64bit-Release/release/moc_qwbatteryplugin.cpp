...
QT_INIT_METAOBJECT const QMetaObject QwBatteryPlugin::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QwBatteryPlugin.data,
    qt_meta_data_QwBatteryPlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
